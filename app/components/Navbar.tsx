    ...
    return (
        ...
        <div className="navbar flex h-12 rounded bg-slate-700 overflow-visible">
            <div className="navbar flex justify-evenly ">
                    ...
                    <Link className="group btn mask mask-squircle w-20 h-20 focus:w-16 focus:h-16 focus:ml-4 border-none bg-teal-700 hover:bg-slate-700 focus:bg-slate-700 focus:animate-pop" href="/personal"><Image className="group-focus:invisible" src="/Person.svg" width={100} height={100} alt="Photo"/></Link>
            </div>
